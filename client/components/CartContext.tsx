...
export const CartProvider = ({ children }: { children: ReactNode }) => {
  ...
  const API_BASE_URL = "https://b23c56c64571.ngrok-free.app";//${API_BASE_URL}

  const fetchCartItems = useCallback(async () => {
    if (!cartToken) return;

    try {
      const response = await fetch('https://b23c56c64571.ngrok-free.app/api/cart/items', {
        headers: {
  ...
  try {
    const response = await fetch(`https://b23c56c64571.ngrok-free.app/api/cart/remove/${cartId}`, {
      method: 'DELETE',
      headers: {
        'Cart-Token': cartToken,
        'ngrok-skip-browser-warning': '69420'
  ...
  const updateQuantity = async (itemId: number, quantity: number) => {
    ...
    try {
      const response = await fetch(
        `https://b23c56c64571.ngrok-free.app/api/cart/update/${itemId}?quantity=${quantity}`,
        {
          method: 'PUT',
          headers: {
            'Cart-Token': cartToken,
...
const clearCart = async () => {
  ...
  try {
    const response = await fetch('https://b23c56c64571.ngrok-free.app/api/cart/clear', {
      method: 'DELETE',
      headers: {
        'Cart-Token': cartToken,
        'ngrok-skip-browser-warning': '69420'
  ...
  const checkout = async (userDetails: UserDetails) => {
    ...
    try {
      ...
      const orderResponse = await fetch('https://b23c56c64571.ngrok-free.app/api/orders/create', {// create nahi tha abhi likha hai
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Cart-Token': cartToken,
